...
The project team must deliver a 10 (min) - 12 (max) minute engaging, well rehearsed presentation, which includes a live demo of the product as a part of the presentation.

During the presentation the whole team should be introduced, a live demo provided, and then further details about the product presented. The presentation may include information on the problem the product is solving, speak to the concept of the product, inspiration, challenges, future opportunities, and anything else the project team deems valuable to share.

All members of the project team must be in attendance during the in class presentation. In addition, all team members must speak during the presentation, though it does not have to be for completely equal times. 
...
The deliverable for the project is worth 30% of your final grade and marked out of 100.
...
The presentation for the project is worth 10% of your final grade and marked out of 100.

|Criteria|Total&nbsp;Marks|How we define excellence|
|----|----|----|
|Slide design|**15%**|The design of the slides are visually exciting, compelling, and portray a strong and consistent brand identity for the project team.|
|Product demo|**15%**|A comprehensive demonstration of the product is delivered to the audience showing the various product features and functionality.|
|Content and Delivery|**50%**|The presentation effectively introduces the team and the product. The product concept and value proposition are clearly articulated. The speakers are engaging. An effective story about the product is delivered to the audience. The presentation comes across as well rehearsed and professsional.|
|Moments of charm|**20%**|The presentation contains annimations, transitions, visual effects, elements that engage the audience in a meaningful way, and contain "one more thing" to further delight the audience.|
